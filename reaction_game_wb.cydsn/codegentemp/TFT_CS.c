...
*
* \funcusage
*  \snippet TFT_CS_SUT.c usage_TFT_CS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_CS_SUT.c usage_TFT_CS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_CS_SUT.c usage_TFT_CS_Read  
*******************************************************************************/
...
* preferred TFT_CS_Read() API because the 
* TFT_CS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TFT_CS_SUT.c usage_TFT_CS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TFT_CS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TFT_CS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TFT_CS_0_INTR       (First pin in the list)
    *  - TFT_CS_1_INTR       (Second pin in the list)
    *  - ...
    *  - TFT_CS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TFT_CS_SUT.c usage_TFT_CS_SetInterruptMode
    *******************************************************************************/
    void TFT_CS_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TFT_CS_0_INTR) != 0u) 
		{ 
			 TFT_CS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TFT_CS_SUT.c usage_TFT_CS_ClearInterrupt
    *******************************************************************************/
