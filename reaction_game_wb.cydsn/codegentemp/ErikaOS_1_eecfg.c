 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_timer) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_timer*/
        #endif
        #ifdef TASK_5_STACK_SIZE
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alrm_randTime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alrm_1000ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alrm_measureTime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, Alarm_4, EE_ALARM }
        #endif
