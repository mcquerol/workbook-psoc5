// ======================================================================
// reaction_game_wb.v generated from TopDesign.cysch
// 02/04/2023 at 14:00
...
module top ;
    ...
    assign Net_3710 = Net_1538 | Net_1541 | Net_1544 | Net_1547;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_3718),
        .rx_data(Net_3719),
        .rx_interrupt(Net_3720),
        .tx(Net_1027),
        .tx_clk(Net_3721),
        .tx_data(Net_3722),
        .tx_en(Net_3723),
        .tx_interrupt(Net_3724));
    ...
    SPI_Master_v2_50_6 TFT_SPI (
        ...
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_3863),
        .sclk(wTFT_SCL),
        .sdat(Net_3864),
        .ss(Net_3865),
        .tx_interrupt(Net_3866));
    ...
    assign Net_3861 = 1'h0;

    assign Net_3867 = 1'h0;
