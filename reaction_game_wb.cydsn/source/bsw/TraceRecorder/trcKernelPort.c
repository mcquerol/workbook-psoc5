...
/***********************************************************************************************
  ...
  * Task defined as a cyclic task. 
  * Alarm started in Task_Init.Can alternatively be initiated in VTraceEnable API
************************************************************************************************/
TASK(TzCtrl)  
{
 ...
 * This function returns current TASK ID
*********************************************************************************/
...
//static void* pCurrentTCB = NULL; ERIKA OS Changes
...
//static portTASK_FUNCTION( TzCtrl, pvParameters ); //ERIKA OS Changes This is declaration of Trz_Ctrl task in FreeRTOS. We have done this in ERIKA OS component in TopDesign
...
unsigned char prvTraceIsSchedulerSuspended(void)
{
	...
	return 0;   
}  //ERIKA OS Changes,At the moment this function is not necessary as this is used only in interrupt context
