...
*
* \funcusage
*  \snippet TFT_DC_SUT.c usage_TFT_DC_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_DC_SUT.c usage_TFT_DC_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_DC_SUT.c usage_TFT_DC_Read  
*******************************************************************************/
...
* preferred TFT_DC_Read() API because the 
* TFT_DC_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TFT_DC_SUT.c usage_TFT_DC_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TFT_DC_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TFT_DC_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TFT_DC_0_INTR       (First pin in the list)
    *  - TFT_DC_1_INTR       (Second pin in the list)
    *  - ...
    *  - TFT_DC_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TFT_DC_SUT.c usage_TFT_DC_SetInterruptMode
    *******************************************************************************/
    void TFT_DC_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TFT_DC_0_INTR) != 0u) 
		{ 
			 TFT_DC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TFT_DC_SUT.c usage_TFT_DC_ClearInterrupt
    *******************************************************************************/
