 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_logic) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_logic*/
        #endif
        #ifdef TASK_4_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread tsk_logic */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_background */
    #endif
