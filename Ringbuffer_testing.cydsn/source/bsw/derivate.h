...
//------------------------------------- [supported targets, select from here]
 ...
 *
 * located @ 0xE000ED18. Customized for 3 bit priority as used in PSoC 5LP
 */
typedef union{
	unsigned int u32:32;						/**< \brief U32 access*/
	struct{
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [4:0] reserved */
				unsigned int PRI_4:3;			/**< \brief Priority of system handler 4, MemManage */
			}B;
		}PRI_4;
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [12:8] reserved */
				unsigned int PRI_15:3;			/**< \brief Priority of system handler 5, BusFault */
			}B;
		}PRI_5;
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [20:16] reserved */
				unsigned int PRI_15:3;			/**< \brief Priority of system handler 6, UsageFault */
			}B;
		}PRI_6;
		unsigned int PRI_7:16;					/** \brief [31:24] reserved*/
	}B;
}CORTEX_SHCRS1_t;

/**\brief System Handler Priority Register 2
 *
 * located @ 0xE000ED1C. Customized for 3 bit priority as used in PSoC 5LP
 */
typedef union{
	unsigned int u32:32;						/**< \brief U32 access*/
	struct{
		unsigned int reserved_24:24;			/** \brief [23:0] reserved*/
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [28:24] reserved */
				unsigned int PRI_14:3;			/**< \brief Priority of system handler 11, SVCall */
			}B;
		}PRI_11;
	}B;
}CORTEX_SHCRS2_t;
 ...
 *
 * located @ 0xE000ED20. Customized for 3 bit priority as used in PSoC 5LP
 */
typedef union{
	unsigned int u32:32;						/**< \brief U32 access*/
	struct{
		unsigned int reserved_16:16;			/** \brief [15:0] reserved*/
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [20:16] reserved */
				unsigned int PRI_14:3;			/**< \brief Priority of system handler 14, PendSV */
			}B;
		}PRI_14;
		union{
			unsigned int u8:8;					/**< \brief U8 access*/
			struct{
				unsigned int reserved_5:5;		/**< \brief [20:24] reserved */
				unsigned int PRI_15:3;			/**< \brief Priority of system handler 15, SysTick exception */
			}B;
		}PRI_15;
	}B;
}CORTEX_SHCRS3_t;
...
#define CORTEX_SHCRS1 (*((CORTEX_SHCRS1_t*)0xE000ED18))
#define CORTEX_SHCRS2 (*((CORTEX_SHCRS2_t*)0xE000ED1C))
#define CORTEX_SHCRS3 (*((CORTEX_SHCRS3_t*)0xE000ED20))
